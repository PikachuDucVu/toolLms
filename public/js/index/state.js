...
export const state = {
    ...
    regularReviewMode: false,
    regularReviewSelectedStudentId: null,
    regularReviewSearch: '',
    regularReviewAlertFilter: 'all',
    regularReviewLevelFilter: 'all',
    regularReviewSort: 'name',
    regularReviewScrollTop: 0,
    regularReviewDrawerScrollTop: 0,
    regularReviewShouldResetScroll: false,
